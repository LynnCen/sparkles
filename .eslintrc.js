module.exports = {
  ...
  rules: {
    ...
    ], // 强制使用一致的缩进，修复 ESLint: Cannot read property 'loc' of undefined Occurred while
    ...
    // ts中使用枚举会提示XXX not used ，禁用基本规则，开启ts的规则，可保证ts中提示正确
    ...
    'guard-for-in': 'warn', // for in遍历过程中对结果进行筛选，强制使用Object.prototype.hasOwnProperty.call(foo, key)或{}.hasOwnProperty.call(foo, key)
    'no-param-reassign': 'off', // 是否禁止修改函数参数
    'prefer-promise-reject-errors': 'off', // Promise仅被Error对象拒绝
    'react-hooks/rules-of-hooks': 'error', // 检查 Hook 的规则
    'react-hooks/exhaustive-deps': [0], // 无需检查 effect 的依赖
  },
};
