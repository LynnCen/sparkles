...
var Screenshots = /** @class */ (function (_super) {
    ...
    Screenshots.prototype.createWindow = function (_a) {
        ...
        // console.log(`load to ${"file://" + require.resolve("react-screenshots/dist/index.html")}`);
        // $win.loadURL("file://" + require.resolve("react-screenshots/dist/index.html"));
        console.log(
            electron_1.app.getAppPath() + "/src/otherRenderProcess/react-screenshots/index.html"
        );
        $win.loadURL(
            "file://" +
                electron_1.app.getAppPath() +
                "/src/otherRenderProcess/react-screenshots/index.html"
        );
        return $win;
    };
    /**
    ...
    Screenshots.prototype.listenIpc = function () {
        ...
        electron_1.ipcMain.on("SCREENSHOTS::OK", function (e, data) {
            ...
            if (!event.defaultPrevented) {
                electron_1.clipboard.writeImage(
                    electron_1.nativeImage.createFromDataURL(data.dataURL)
                );
                _this.endCapture();
            }
        });
