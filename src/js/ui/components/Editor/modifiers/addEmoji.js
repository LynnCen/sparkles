...
export default function addEmoji(editorState, emojiItem, mode = Mode.INSERT) {
    const emoji = emojiItem.unicode;
    ...
    const newEditorState = EditorState.push(editorState, emojiAddedContent, "insert-fragment");
