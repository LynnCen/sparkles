// 不同项目需要自行引入的函数
import { getCss as _getCss } from '@/common/utils/get-css';
import { getScript as _getScript } from '@/common/utils/get-script';
...
export const videoTypes = ['mp4', '3gp', 'm3u8', 'mov'];
...
export const qiniuTokenUrl = '/qiniu/token';
...
// 高德key
export const aMapKey = 'f0efdd9fb507d57fbed4b0a900c8f3e2';
