...
/**
 * @description 经纬度坐标，用来描述地图上的一个点位置, 目前高德地图使用的是 GCJ-02 坐标
 */
export type LngLat = ArrayLngLat | LngLatPos | FullLngLatPos;

/**
 * @description 路径数组
 */
export type Path = Array<ArrayLngLat> | Array<FullLngLatPos>
