/**
 * @Description 新建匹配点位 卡旺卡需求请求列表接口不同，并且需要带上商圈id
 */
...
import { associateTask } from '@/common/api/expandStore/expansiontask';
import { getCircleTaskChancePointList } from '@/common/api/expandStore/expansionCircleTask';
...
const CreatePointMatching : FC<Props> = ({
  ...
  const methods = useMethods({
    ...
    async loadData(params) {
      const data = await getCircleTaskChancePointList({
        ...params,
        modelClusterId, // 商圈id
      });
      return {
