...
import SupplierContract from 'src/common/components/Select/SupplierContract';

interface SupplierContractConfig extends SelectProps {
  immediateOnce?: boolean;
}
export interface SupplierContractProps {
  // form: any;
  placeholder?: string;
  allowClear?: boolean;
  extraParams?: any;
  config?: SupplierContractConfig;
...
const FormSupplier: FC<SupplierContractProps & DefaultFormItemProps> = ({
  name,
  label,
  rules,
  // form,
