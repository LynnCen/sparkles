...
import BrandCenterBrand from 'src/common/components/Select/BrandCenterBrand';

interface BrandCenterBrandConfig extends SelectProps {
  immediateOnce?: boolean;
}
export interface BrandCenterBrandProps {
  placeholder?: string;
  allowClear?: boolean;
  extraParams?: any;
  config?: BrandCenterBrandConfig;
...
const FormBrandCenterBrand: FC<BrandCenterBrandProps & DefaultFormItemProps> = ({
  name,
  label,
  rules,
...
export default FormBrandCenterBrand;
