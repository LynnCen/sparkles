...
export interface V2BarLineChartProps {
  /**
   * @description 图表标题
   */
  title?: string;
  ...
  xAxisData: string[];
  /**
   * @description 图表数据 更多配置见 https://echarts.apache.org/zh/option.html#series-line
   */
  seriesData: any[];
  /**
...
/**
* @description 便捷文档地址
* @see https://reactmobile.lanhanba.net/charts/v2-bar-line-chart
*/

const V2BarLineChart: React.FC<V2BarLineChartProps> = (props) => {
  const {
    title,
    theme = 'blue',
    width,
      ...
      unstable_batchedUpdates(() => {
        setOptions({
          ...
          series: seriesData.map((item, index) => {
            return {
              ...(item.type === 'bar' ? seriesBarBaseConfig : seriesLineBaseConfig),
              ...item,
              data: item.data,
  ...
  return (
    <div className={cs(styles.V2BarLineChartWrap, wrapperClassName)} style={{ width, height }}>
      <div ref={chartRef} className={styles.V2BarLineChart}></div>
    </div>
  );
};

export default V2BarLineChart;
