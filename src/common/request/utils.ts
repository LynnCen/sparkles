 ...
 */
export function getHeader(version, isPost = false): any {
  ...
  if (err.response) {
    ...
    switch (status) {
      ...
      case 404:
        ...
        break;
      // case 422: // 接口为按规则进行了全部422抛异常，无法控制是否报错，直接移除这个约定
