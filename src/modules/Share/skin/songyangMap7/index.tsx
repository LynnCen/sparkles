...
import { TitleName, UniversalDom, TextBox, Personnel, NumberList, TextLine, HorizontalBar, PieChart, LineChart, BarChart } from '../../Components/SyMapComponent'
...
export default function SongyangMap7({ visible, template }: Props) {
            ...
            >
                {
                    config ? <>
                        <UniversalDom
                            title={config.leftContent.child1.title}
                        >
                            <div style={{
                                display: "flex",
                        ...
                        <UniversalDom
                            title={config.leftContent.child2.title}
                        >
                            <div style={{ height: "3.5rem" }}>
                                <HorizontalBar
                                    data={config.leftContent.child2.content}
                                />
                            </div>
                        </UniversalDom>
                        <UniversalDom
                            title={config.leftContent.child3.title}
                        >
                            <div style={{ height: "3.5rem" }}>
                                <HorizontalBar
                                    data={config.leftContent.child3.content}
                                />
                            </div>
                        </UniversalDom>
                    </> : <Spin size="large" />
                    ...
                    config ? <>
                        <UniversalDom title={config.rightContent.child1.title}>
                            <div style={{ height: "3.74rem" }}>
                                <PieChart data={config.rightContent.child1.content} />
                            </div>
                        </UniversalDom>
                        <UniversalDom title={config.rightContent.child2.title}>
                            <div style={{ height: "2.7rem" }}>
                                <LineChart data={config.rightContent.child2.content} />
                            </div>
                        </UniversalDom>
                        <UniversalDom title={config.rightContent.child3.title}>
                            <div style={{ height: "2.7rem" }}>
                                <BarChart data={config.rightContent.child3.content} />
                            </div>
                        </UniversalDom>
                    </> : <Spin size="large" />
                }
