...
import { SliderChart1, BarChart, SliderChart2, Stacked, Basic } from './charts'
import { LeftLabel, RightLabel, RightLabel2 } from './components'
...
export default function DtVillage({ visible, template }: Props) {
                            ...
                            }
                            {
                                config.leftContent.content2.map((item, index) => {
                                    return <LeftLabel
                                        ...
                                        content={
                                            // <div>{item.number}</div>
                                            <Stacked data={item.data} color={item.color} fields={item.fields} width={143} />
                                        }
                                    />
                                })
                            }
