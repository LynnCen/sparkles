/**
 * @Description 发起点位审批-表单，
 *  参照组件 src/views/fishtogether/pages/chancepointmanage/components/FormDrawer/components/Main.tsx
 */
...
const SpotForm: FC<SpotFormProps> = ({
  formData,
  active,
  pcdIdentification,
  form,
