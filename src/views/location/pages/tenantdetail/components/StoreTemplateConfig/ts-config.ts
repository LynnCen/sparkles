...
export interface StoreTemplateModalProps {
...
// 新增模板Excel
export interface UploadExcelModalValuesProps {
  id?: number;
...
export interface UploadExcelProps {
  setOperateUploadExcel: Function;
  operateUploadExcel: UploadExcelModalValuesProps;
  onSearch: Function;
}
