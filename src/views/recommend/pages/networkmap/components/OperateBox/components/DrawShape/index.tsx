...
import { debounce, isArray, isNotEmptyAny, urlParams, } from '@lhb/func';
...
const DrawShape: FC<any> = ({
  ...
  const getAddressPermissions = async() => {
    const address = await getTreeSelection({ planId, type: 1, childCompanyId: branchCompanyId || companyParams?.branchCompanyId });
