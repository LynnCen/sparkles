...
interface DevDptKPIReportTableProps {
  filters:Object;
  mainHeight?:number;
  tableConfig?:Object;
}

const DevDptKPIReportTable:FC<DevDptKPIReportTableProps> = ({
  mainHeight = 360,
  filters,
  tableConfig = {}
}) => {
  ...
  const loadData = async(params:any) => {
    // https://yapi.lanhanba.com/project/532/interface/api/70454
    const res = await post('/standard/home/company/performanceReport/page', params);
    const list :any[] = res.meta?.total ? [({
      ...res.meta?.total,
      companyName: '全国'
    } || { companyName: '全国' })].concat(res.objectList) : res.objectList;
...
export default DevDptKPIReportTable;
