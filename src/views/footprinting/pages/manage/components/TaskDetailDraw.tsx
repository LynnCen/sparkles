...
import { AnalysisStatusEnum, ProcessStatus } from '../../reviewdetail/ts-config';
  ...
  useEffect(() => {
    if (taskDetail.visible) {
      (async () => {
        ...
        const result = await post('/checkSpot/project/query', { id: taskDetail.id }, true);
        ...
        {data.loading ? (
          ...
          <div className={cs('bg-fff', 'pd-20')}>
            ...
            <Row>
              ...
              <DetailInfo span={24} title='附件' value={data.result.attachment}>
