...
const Search: FC<any> = ({ form, change }) => {
  ...
  return (
    <SearchForm labelLength={6} onSearch={change} form={form}>
      ...
      />
      <V2FormInput label='租户/团队名称' name='tenantName' />
      ...
      <V2FormProvinceList label='需求城市' name='pcdIds' placeholder='请选择省市/省市区' config={{ changeOnSelect: true }}/>
      <V2FormCascader
        label='所属行业'
        name='industryId'
        config={{
      ...
      <V2FormSelect label='是否关联点位' name='hasRelationSpot' options={[{ label: '是', value: true }, { label: '否', value: false }]}/>
      <V2FormInput label='踩点设备码' name='deviceCode' />
    </SearchForm>
  );
};
